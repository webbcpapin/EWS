...
export default function Berita() {
  ...
  return (
    <div className="space-y-5">
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <Button
                      ...
                      onClick={(e) => { e.stopPropagation(); setDetailArticle(article); }}
                    >
      ...
      {/* Detail Dialog */}
      <Dialog open={!!detailArticle} onOpenChange={() => setDetailArticle(null)}>
